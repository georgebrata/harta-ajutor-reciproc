          ...
          <nav className='mdl-navigation'>
            <div>
              <NavLink to='/' className='mdl-navigation__link' activeClassName='is-active' exact>
                <i className='material-icons mdl-list__item-icon'>home</i> Harta
              </NavLink>
              { !this.props.smallScreen ? (
                <NavLink to='/favorites/' className='mdl-navigation__link' activeClassName='is-active'>
                  <i className='material-icons mdl-list__item-icon'>favorite</i> Prietenii mei
                </NavLink>
              ) : null }
              <NavLink to='/suggest/' className='mdl-navigation__link' activeClassName='is-active'>
                <i className='material-icons mdl-list__item-icon'>add_location</i> Inscrie-te ca voluntar
              </NavLink>
            </div>
            <div>
              <a href='https://georgebrata.ro' target='_blank'
                className='mdl-navigation__link'>
                <i className='material-icons mdl-list__item-icon'>code</i> Coded with ❤️ by George
              </a>
            </div>
          </nav>
        </div>
